//
//  HABulbListTableViewController.m
//  Octyrion
//
...
#import "HABulbListTableViewController.h"
#import "UIImage+JTColor.h"

@interface HABulbListTableViewController ()

@end

@implementation HABulbListTableViewController
...
- (void)viewDidLoad
{
    ...
    self.bulbs = [NSMutableArray arrayWithCapacity:20];
    HABulb *bulb = [HABulb new];
    bulb.name = @"Stanley";
    bulb.brightness = 0.5f;
    bulb.color = [UIColor redColor];
    [self.bulbs addObject:bulb];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    UITableViewCell *cell = [tableView
                             dequeueReusableCellWithIdentifier:@"BulbCell"];
	HABulb *bulb = [self.bulbs objectAtIndex:indexPath.row];
	UILabel *nameLabel = (UILabel *)[cell viewWithTag:101];
    nameLabel.text = bulb.name;
    UIImageView *colorView = (UIImageView *)[cell viewWithTag:100];
